...
class Workspace:
    ...
    def train(self, score_list_path):
        # predicates
    ...
    def load_snapshot(self, savedir):
        ...
        if payload is not None:
            ...
            self.global_step = payload['_global_step']
            self.global_episode = payload['_global_episode']  
            self.score_list = hu.load_pkl(score_list_path) 


# @hydra.main(config_path='.', config_name='pretrain')
def main(exp_config, save_dir):
    from pretrain import Workspace as W
    root_dir = save_dir
    workspace = W(exp_config)
    score_list_path = os.path.join(root_dir, "score_list.pkl")
    if os.path.exists(score_list_path):
        # resume experiment
        workspace.load_snapshot(save_dir) #model.load_state_dict(hu.torch_load(model_path))
        # score_list = hu.load_pkl(score_list_path)
    workspace.train(score_list_path)
